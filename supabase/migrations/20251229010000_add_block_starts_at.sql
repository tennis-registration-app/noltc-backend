-- Add block_starts_at to get_court_board function
-- This allows the frontend to properly display block start times
...
COMMENT ON FUNCTION get_court_board IS
  'Returns court board data with consistent timestamp. Now includes block_starts_at. Safe for anon access - returns sanitized data only.';
