-- Update end_session_atomic to accept and merge eventData
-- This allows the trigger field (overtime_takeover, stale_session_cleanup, etc.)
-- to be stored in session_events for undo-overtime-takeover validation
