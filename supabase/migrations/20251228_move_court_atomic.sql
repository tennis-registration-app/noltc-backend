-- Atomic move_court function with row-level locking
-- Prevents race conditions when moving sessions between courts
-- Note: GRANT is included via SECURITY DEFINER pattern
